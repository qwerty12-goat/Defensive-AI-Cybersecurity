"""Step 9: Formal exploratory data analysis using the training split only.
...
RESULTS_DIR = PROJECT_ROOT / "results" / "step9_eda"
...
def main() -> None:
    ...
    print(f"\nSaved Step 9 outputs to: {RESULTS_DIR}")
